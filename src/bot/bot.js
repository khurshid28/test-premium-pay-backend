...
bot.on("message", async (msg) => {
  ...
  if (
    ...
    if (msg.text == "/data") {
      ...
      zayavkalar1 = await new Promise(function (resolve, reject) {
        db.query(
          `SELECT count(id)  from Zayavka WHERE  status='progress' and DATE(now())>DATE(created_time) and DATE(now()) - 1 < DATE(created_time)`,
          function (err, results, fields) {
            if (err) {
              resolve(null);
              return null;
      ...
      zayavkalar2 = await new Promise(function (resolve, reject) {
        db.query(
          `SELECT count(id)  from Zayavka WHERE  status='canceled_by_scoring' and DATE(now())>DATE(created_time) and DATE(now()) - 1 < DATE(created_time)`,
          function (err, results, fields) {
            if (err) {
              resolve(null);
              return null;
      ...
      zayavkalar3 = await new Promise(function (resolve, reject) {
        db.query(
          `SELECT count(id) from Zayavka WHERE  status='canceled_by_client' and DATE(now())>DATE(created_time) and DATE(now()) - 1 < DATE(created_time)`,
          function (err, results, fields) {
            if (err) {
              resolve(null);
              return null;
      ...
      zayavkalar4 = await new Promise(function (resolve, reject) {
        db.query(
          `SELECT count(id) from Zayavka WHERE  status='canceled_by_daily' and DATE(now())>DATE(created_time) and DATE(now()) - 1 < DATE(created_time)`,
          function (err, results, fields) {
            if (err) {
              resolve(null);
              return null;
      ...
      zayavkalar5 = await new Promise(function (resolve, reject) {
        db.query(
          `SELECT count(id) from Zayavka WHERE  status='finished' and DATE(now())>DATE(created_time) and DATE(now()) - 1 < DATE(created_time)`,
          function (err, results, fields) {
            console.log(err);
            if (err) {
              resolve(null);
      ...
      zayavkalar8 = await new Promise(function (resolve, reject) {
        db.query(
          `SELECT count(id) from Zayavka WHERE status='paid' and DATE(now())>DATE(created_time) and DATE(now()) - 1 < DATE(created_time)`,
          function (err, results, fields) {
            console.log(err);
            if (err) {
              resolve(null);
